    ...
    <div className="Lan-container">
      ...
      {menuToggle && (
        <ul className="menuList">
          <li> <button className="sNavbutton">University</button></li>
          <li> <button className="sNavbutton">Courses</button></li>
          <li><Link to={'/upload'}>
